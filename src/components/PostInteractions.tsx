...
const PostInteractions = (props: PostInteractionsProps) => {
    return (
        <div className='flex items-center justify-between my-2 gap-4 sm:gap-10 xl:gap-16 text-textGray'>
            <div className=' flex items-center justify-between flex-1'>
                ...
                <div className='group flex items-center gap-2 cursor-pointer'>
                    ...
                    <span className='group-hover:text-iconBlue text-sm transition-all duration-300'>148</span>
                </div>
                {/*Reposts*/}
                <div className='group flex items-center gap-2 cursor-pointer'>
                    ...
                    <span className='group-hover:text-iconGreen text-sm transition-all duration-300'>25</span>
                </div>
                {/*Likes*/}
                <div className='group flex items-center gap-2 cursor-pointer'>
                    <svg
                    ...
                    <span className='group-hover:text-iconPink text-sm transition-all duration-300'>450</span>
                </div>
            </div>
